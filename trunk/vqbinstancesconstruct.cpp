...
void VqbInstancesConstruct::updateCurrentTriple()
{
    QString triple;
...
void VqbInstancesConstruct::updateTypes()
{
...
void VqbInstancesConstruct::updateCompletersSubject(QString text)
{
...
void VqbInstancesConstruct::updateCompletersPredicate(QString text)
{
    Q_UNUSED(text);
}

void VqbInstancesConstruct::updateCompletersObject(QString text)
{
    Q_UNUSED(text);
}
...
void VqbInstancesConstruct::colorLineEdits()
{
...
void VqbInstancesConstruct::on_buttonAddToOutput_clicked()
{
